...
class Location {
  ...
  //RANDOTODO fix wacky ordering
    ...
    static Location Fairy(RandomizerCheck rc, RandomizerCheckQuest quest_, RandomizerCheckArea area_, uint8_t scene_, int32_t actorParams_, std::string&& shortName_, std::string&& spoilerName_, const RandomizerHintTextKey hintKey, SpoilerCollectionCheck collectionCheck);
